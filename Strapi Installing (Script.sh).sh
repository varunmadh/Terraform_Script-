...
sudo -i -u postgres createuser varun
sudo -i -u postgres psql -c "ALTER USER varun PASSWORD 'admin';"
sudo -i -u postgres psql -c "GRANT ALL PRIVILEGES ON DATABASE strapi TO varun;"
